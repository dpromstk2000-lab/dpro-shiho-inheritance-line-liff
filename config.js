  ...
  try {
    ...
    if (tutorialRequested) {
      if (!document.querySelector('link[data-dpro-shiho-tutorial]')) {
        ...
        tutorialCss.href = `${SITE_BASE_URL}/tutorial.css?v=SHIHO-TUTORIAL-R3-RECOVERY3-20260827`;
      ...
      if (!document.querySelector('script[data-dpro-shiho-tutorial]')) {
        ...
        tutorialScript.src = `${SITE_BASE_URL}/tutorial.js?v=SHIHO-TUTORIAL-R3-RECOVERY3-20260827`;
